...
bool loadMedia() {
  ...
  //Load foo' texture
  if(!g_spriteSheetTexture.loadFromFile("./dots.png")) {
...
int main() {
  ...
  while(!quit) {
    ...
    g_spriteSheetTexture.render(SCREEN_WIDTH - g_spriteClips[3].w, 
				SCREEN_HEIGHT - g_spriteClips[3].h, &g_spriteClips[3]);
